...
#ifndef _MOCKMOD_SCMI_SYSTEM_POWER_REQ_EXTRA_H
#define _MOCKMOD_SCMI_SYSTEM_POWER_REQ_EXTRA_H

#include "unity.h"
#include "mod_scmi_system_power_req_extra.h"
...
void Mockmod_scmi_system_power_req_extra_Init(void);
void Mockmod_scmi_system_power_req_extra_Destroy(void);
void Mockmod_scmi_system_power_req_extra_Verify(void);
