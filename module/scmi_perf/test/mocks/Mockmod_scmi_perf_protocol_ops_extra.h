...
#ifndef _MOCKMOD_SCMI_PERF_PROTOCOL_OPS_EXTRA_H
#define _MOCKMOD_SCMI_PERF_PROTOCOL_OPS_EXTRA_H

#include "unity.h"
#include "mod_scmi_perf_protocol_ops_extra.h"
...
void Mockmod_scmi_perf_protocol_ops_extra_Init(void);
void Mockmod_scmi_perf_protocol_ops_extra_Destroy(void);
void Mockmod_scmi_perf_protocol_ops_extra_Verify(void);
