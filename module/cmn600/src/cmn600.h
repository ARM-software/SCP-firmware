...
struct cmn600_rnsam_reg {
    ...
    FWK_RW uint64_t SYS_CACHE_GRP_NOHASH_NODEID;
           uint8_t  RESERVED4[0xCE0 - 0xCA0];
    FWK_RW uint64_t NON_HASH_TGT_NODEID_GRP2[2];
...
#define CMN600_RNSAM_MAX_NON_HASH_MEM_REGION_ENTRIES(nr_reg) \
    ((nr_reg)*CMN600_RNSAM_NON_HASH_TGT_NODEID_ENTRIES_PER_GROUP)

/*!
 * r1p0, r1p1 and r1p3 revisions of CMN600 has two NON_HASH_TGT_NODEID registers
 */
#define CMN600_RNSAM_NON_HASH_TGT_NODEID_REGS_2 2

/*!
 * r1p2 and r2p0 revisions of CMN600 has three NON_HASH_TGT_NODEID registers
 */
#define CMN600_RNSAM_NON_HASH_TGT_NODEID_REGS_3 3

/*!
 * r3p0 and above revisions of CMN600 has five NON_HASH_TGT_NODEID
 * registers
 */
#define CMN600_RNSAM_NON_HASH_TGT_NODEID_REGS_5 5
