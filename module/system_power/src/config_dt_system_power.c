...
#define SPD_ELEM_DATA(n) \
    .sys_ppu_id = FWK_DT_FWK_ID(SPD_COMPAT, n, ppu_id), \
    .api_id = FWK_DT_FWK_API_ID(SPD_COMPAT, n, api_id), \
...
static struct mod_system_power_config sys_pwr_config_data = {
    ...
    .driver_id = FWK_DT_FWK_MOD_ID(SYSPWR_COMPAT, 0, driver_id),
    .driver_api_id = FWK_DT_FWK_API_ID(SYSPWR_COMPAT, 0 , api_id),
