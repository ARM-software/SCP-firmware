...
#define mod_scmi_from_protocol_api_respond_ExpectAnyArgs() mod_scmi_from_protocol_api_respond_CMockExpectAnyArgs(__LINE__)
void mod_scmi_from_protocol_api_respond_CMockExpectAnyArgs(UNITY_LINE_TYPE cmock_line);
#define mod_scmi_from_protocol_api_respond_Expect(service_id, payload, size) mod_scmi_from_protocol_api_respond_CMockExpect(__LINE__, service_id, payload, size)
...
typedef void (* CMOCK_mod_scmi_from_protocol_api_respond_CALLBACK)(fwk_id_t service_id, const void* payload, size_t size, int cmock_num_calls);
