...
#define CFG_CLK_DEV_ELEM_DATA(n) \
    .driver_id = FWK_DT_FWK_ID(CLK_DEV_COMPAT, n, driver_id), \
    .api_id = FWK_DT_FWK_ID(CLK_DEV_COMPAT, n, api_id), \
    .pd_source_id = FWK_DT_OPT_FWK_ID(CLK_DEV_COMPAT, n, pd_source_id),

#define CFG_CLK_DEV_ELEM_INIT(n) \
    [n] = { \
    .name = FWK_DT_INST_PROP(CLK_DEV_COMPAT, n, name), \
    .data = &((struct mod_clock_dev_config) { \
        CFG_CLK_DEV_ELEM_DATA(n) \
        }), \
    },
