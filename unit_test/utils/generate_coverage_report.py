...
Filename = "scp_v2_unit_test_coverage.info"
OutFileName = "scp_v2_unit_test_coverage_filtered.info"

STARTER = "SF:"
regexes = [re.compile(r"unit_test/"), re.compile(r"module/.{1,50}/test"),
