...
#ifndef SCP_RDDANIELXLR_SCMI_H
#define SCP_RDDANIELXLR_SCMI_H

/* SCMI agent identifiers */
enum scp_rddanielxlr_scmi_agent_id {
    /* 0 is reserved for the platform */
    SCP_SCMI_AGENT_ID_PSCI = 1,
};

/* SCMI service indexes */
enum scp_rddanielxlr_scmi_service_idx {
    SCP_RDDANIELXLR_SCMI_SERVICE_IDX_PSCI,
    SCP_RDDANIELXLR_SCMI_SERVICE_IDX_COUNT,
};

#endif /* SCP_RDDANIELXLR_SCMI_H */
