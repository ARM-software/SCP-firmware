...
static struct mod_system_power_config system_power_config = {
    ...
    /* System driver */
    .driver_id = FWK_ID_MODULE_INIT(FWK_MODULE_IDX_RDDANIELXLR_SYSTEM),
    .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RDDANIELXLR_SYSTEM,
...
static const struct fwk_element *rddanielxlr_system_get_element_table(
    fwk_id_t unused)
{
    ...
    unsigned int ppu_idx_base = rddanielxlr_core_get_core_count() +
