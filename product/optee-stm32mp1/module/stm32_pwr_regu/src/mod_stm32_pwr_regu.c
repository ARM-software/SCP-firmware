                               ...
                               uint8_t *mode_id)
{
    ...
    *mode_type = MOD_VOLTD_MODE_TYPE_ARCH;
    ...
    FMSG("SCMI voltd %u: get_config PWR#%u = %s",
                               ...
                               uint8_t mode_id)
{
    ...
    FMSG("SCMI voltd %u: set_config PWR#%u %s",
         fwk_id_get_element_idx(dev_id), ctx->pwr_id,
         mode_id == MOD_VOLTD_MODE_ID_ON ? "on" : "off");
...
static int pwr_regu_get_level(fwk_id_t dev_id, int *level_uv)
{
    ...
    *level_uv = pwr_regu_level(ctx->pwr_id);
    ...
    FMSG("SCMI voltd %u: get_level PWR#%u = %d",
...
static int pwr_regu_set_level(fwk_id_t dev_id, int level_uv)
{
    ...
    FMSG("SCMI voltd %u: set_level PWR#%u to %d",
         fwk_id_get_element_idx(dev_id), ctx->pwr_id, level_uv);
...
static int pwr_regu_get_info(fwk_id_t dev_id, struct mod_voltd_info *info)
{
    ...
    FMSG("SCMI voltd %u: get_info PWR#%u",
         fwk_id_get_element_idx(dev_id), ctx->pwr_id);
                                     ...
                                     int32_t *level_uv)
{
    ...
    *level_uv = pwr_regu_level(ctx->pwr_id);
    ...
    FMSG("SCMI voltd %u: get_level_from_index PWR#%u = %"PRId32,
         fwk_id_get_element_idx(dev_id), ctx->pwr_id, *level_uv);
