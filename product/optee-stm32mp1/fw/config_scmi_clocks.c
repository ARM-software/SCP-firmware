...
static const struct fwk_element optee_clock_elt[] = {
    /* Clocks exposed to agent SCMI0 */
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_HSE),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_HSI),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_CSI),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_LSE),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_LSI),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_PLL2_Q),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_PLL2_R),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_MPU),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_AXI),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_BSEC),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_CRYP1),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_GPIOZ),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_HASH1),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_I2C4),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_I2C6),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_IWDG1),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_RNG1),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_RTC),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_RTCAPB),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_SPI6),
    OPTEE_CLOCK_ELT(CLK_IDX_SCMI0_USART1),
    /* Termination entry */
    [CLK_IDX_COUNT] = { 0 }
};
