...
enum voltd_elt_idx {
    ...
    VOLTD_IDX_SCMI0_STPMIC1_BUCK1,
    VOLTD_IDX_SCMI0_STPMIC1_BUCK2,
    VOLTD_IDX_SCMI0_STPMIC1_BUCK3,
    VOLTD_IDX_SCMI0_STPMIC1_BUCK4,
    VOLTD_IDX_SCMI0_STPMIC1_LDO1,
    VOLTD_IDX_SCMI0_STPMIC1_LDO2,
    VOLTD_IDX_SCMI0_STPMIC1_LDO3,
    VOLTD_IDX_SCMI0_STPMIC1_LDO4,
    VOLTD_IDX_SCMI0_STPMIC1_LDO5,
    VOLTD_IDX_SCMI0_STPMIC1_LDO6,
    VOLTD_IDX_SCMI0_STPMIC1_VREFDDR,
    VOLTD_IDX_SCMI0_STPMIC1_BOOST,
    VOLTD_IDX_SCMI0_STPMIC1_PWR_SW1,
    VOLTD_IDX_SCMI0_STPMIC1_PWR_SW2,
    VOLTD_IDX_COUNT
};
...
static struct mod_scmi_voltd_device scmi0_voltd_device[] = {
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_REG11),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_REG18),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_USB33),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_BUCK1),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_BUCK2),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_BUCK3),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_BUCK4),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO1),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO2),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO3),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO4),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO5),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_LDO6),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_VREFDDR),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_BOOST),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_PWR_SW1),
    SCMI_VOLTD_ELT_ID(VOLTD_SCMI0_STPMIC1_PWR_SW2),
};

static const struct mod_scmi_voltd_agent voltd_agent_table[SCMI_AGENT_ID_COUNT] = {
    [SCMI_AGENT_ID_NSEC0] = {
        .device_table = scmi0_voltd_device,
        .domain_count = FWK_ARRAY_SIZE(scmi0_voltd_device),
    },
};
...
static const struct fwk_element voltd_elt[] = {
    [VOLTD_IDX_SCMI0_REG11] = VOLTD_STM32_PWR_ELT_ID(STM32_PWR_REG11),
    [VOLTD_IDX_SCMI0_REG18] = VOLTD_STM32_PWR_ELT_ID(STM32_PWR_REG18),
    [VOLTD_IDX_SCMI0_USB33] = VOLTD_STM32_PWR_ELT_ID(STM32_PWR_USB33),
    [VOLTD_IDX_SCMI0_STPMIC1_BUCK1] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_BUCK1),
    [VOLTD_IDX_SCMI0_STPMIC1_BUCK2] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_BUCK2),
    [VOLTD_IDX_SCMI0_STPMIC1_BUCK3] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_BUCK3),
    [VOLTD_IDX_SCMI0_STPMIC1_BUCK4] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_BUCK4),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO1] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO1),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO2] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO2),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO3] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO3),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO4] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO4),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO5] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO5),
    [VOLTD_IDX_SCMI0_STPMIC1_LDO6] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_LDO6),
    [VOLTD_IDX_SCMI0_STPMIC1_VREFDDR] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_VREFDDR),
    [VOLTD_IDX_SCMI0_STPMIC1_BOOST]   = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_BOOST),
    [VOLTD_IDX_SCMI0_STPMIC1_PWR_SW1] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_PWR_SW1),
    [VOLTD_IDX_SCMI0_STPMIC1_PWR_SW2] = VOLTD_STM32_PMIC_ELT_ID(STPMIC1_REGU_PWR_SW2),
