...
enum resetd_elt_idx {
    ...
    RESETD_IDX_SCMI0_MCU_HOLD_BOOT,
    RESETD_IDX_COUNT
};
...
static const struct mod_stm32_reset_dev_config stm32_resetd_cfg[] = {
    ...
    STM32_RESET_CFG(RESETD_IDX_SCMI0_MCU_HOLD_BOOT, MCU_HOLD_BOOT_R, "mcu-hold-boot"),
};
...
static const struct mod_scmi_reset_domain_device scmi_resetd_device[] = {
    ...
    [RST_SCMI0_MCU_HOLD_BOOT]    = SCMI_RESETD_ELT_ID(RESETD_IDX_SCMI0_MCU_HOLD_BOOT),
};
...
static const struct fwk_element resetd_elt[] = {
    ...
    RESETD_ELT(RESETD_IDX_SCMI0_MCU_HOLD_BOOT),
    /* Termination entry */
    [RESETD_IDX_COUNT] = { 0 }
};
...
static const struct fwk_element optee_reset_elt[] = {
    /* Reset domaines exposed to agent SCMI0 */
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_SPI6),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_I2C4),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_I2C6),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_USART1),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_STGEN),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_GPIOZ),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_CRYP1),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_HASH1),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_RNG1),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_MDMA),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_MCU),
    OPTEE_RESET_ELT(RESETD_IDX_SCMI0_MCU_HOLD_BOOT),
    /* Termination entry */
    [RESETD_IDX_COUNT] = { 0 }
};
