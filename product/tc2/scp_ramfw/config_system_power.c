...
static struct mod_system_power_config system_power_config = {
    ...
    /* System driver */
    .driver_id = FWK_ID_MODULE_INIT(FWK_MODULE_IDX_TC2_SYSTEM),
    .driver_api_id = FWK_ID_API_INIT(
        FWK_MODULE_IDX_TC2_SYSTEM,
...
static const struct fwk_element *tc2_system_get_element_table(fwk_id_t unused)
{
...
const struct fwk_module_config config_system_power = {
    .elements = FWK_MODULE_DYNAMIC_ELEMENTS(tc2_system_get_element_table),
