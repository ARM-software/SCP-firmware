...
static const uint32_t cluster_pd_allowed_state_mask_table[2] = {
    ...
    [MOD_PD_STATE_ON] = TC2_CLUSTER_VALID_STATE_MASK,
};
...
static const uint32_t core_pd_allowed_state_mask_table[2] = {
    ...
    [MOD_PD_STATE_ON] = TC2_CORE_VALID_STATE_MASK,
};
 ...
 */
static const struct fwk_element *tc2_power_domain_get_element_table(
    fwk_id_t module_id)
{
    return create_power_domain_element_table(
        tc2_core_get_core_count(),
        ...
        tc2_power_domain_static_element_table,
        FWK_ARRAY_SIZE(tc2_power_domain_static_element_table));
}
...
const struct fwk_module_config config_power_domain = {
    .elements = FWK_MODULE_DYNAMIC_ELEMENTS(tc2_power_domain_get_element_table),
    .data = &tc2_power_domain_config,
};
