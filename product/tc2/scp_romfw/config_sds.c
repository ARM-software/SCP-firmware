...
static_assert(
    FWK_ARRAY_SIZE(sds_module_regions) == TC2_SDS_REGION_COUNT,
...
static struct fwk_element sds_element_table[4] = {
    {
        ...
        .data = &((struct mod_sds_structure_desc){
            .id = TC2_SDS_CPU_INFO,
            .size = TC2_SDS_CPU_INFO_SIZE,
            .region_id = TC2_SDS_REGION_SECURE,
            .finalize = true,
        }),
    },
    {
        ...
        .data = &((struct mod_sds_structure_desc){
            .id = TC2_SDS_FEATURE_AVAILABILITY,
            .size = TC2_SDS_FEATURE_AVAILABILITY_SIZE,
    ...
    },
    {
        .name = "Bootloader",
        .data = &((struct mod_sds_structure_desc){
            .id = TC2_SDS_BOOTLOADER,
            .size = TC2_SDS_BOOTLOADER_SIZE,
            .region_id = TC2_SDS_REGION_SECURE,
            .finalize = true,
        }),
    },
...
static_assert(
    SCP_SDS_MEM_SIZE > TC2_SDS_CPU_INFO_SIZE +
            TC2_SDS_FEATURE_AVAILABILITY_SIZE + TC2_SDS_BOOTLOADER_SIZE,
