...
#ifndef N1SDP_MCP_IRQ_H
#define N1SDP_MCP_IRQ_H

#include <fwk_interrupt.h>

#define MCP_WDOG_IRQ FWK_INTERRUPT_NMI /* MCP Watchdog (SP805) */

enum mcp_n1sdp_interrupt {
    ...
    MHU_AP_NONSEC_IRQ               = 34, /* MHU non-secure irq from AP to
                                             MCP */
    ...
    MHU_SCP_NONSEC_IRQ              = 84, /* MHU non-secure irq from SCP to
                                             MCP */
    ...
    PCIE_LOCAL_INT_REST_IRQ         = 221, /* PCIe local error & status
                                              interrupt */
    PCIE_LOCAL_INT_RAS_IRQ          = 222, /* PCIe local RAS interrupt */
    CCIX_AER_IRQ                    = 223, /* PCIe address enable interrupt */
    CCIX_LOCAL_INT_REST_IRQ         = 224, /* PCIe local error & status
                                              interrupt */
