...
static const struct fwk_element
    service_table[MCP_N1SDP_SCMI_SERVICE_IDX_COUNT+1] = {
        [MCP_N1SDP_SCMI_SERVICE_IDX_SCP] = {
            ...
            .data = &((struct mod_scmi_service_config) {
                ...
                .scmi_agent_id = MCP_N1SDP_SCMI_AGENT_IDX_MANAGEMENT,
                .scmi_entity_role = MOD_SCMI_ROLE_AGENT,
            }),
        },
        [MCP_N1SDP_SCMI_SERVICE_IDX_COUNT] = { 0 }
};
...
static struct mod_scmi_agent agent_table[MCP_N1SDP_SCMI_AGENT_IDX_COUNT] = {
