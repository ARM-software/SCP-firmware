...
typedef enum IRQn {
    ...
    PPU_CORES0_IRQ = 50, /* Consolidated PPU Interrupt for
                            cores 1-32, 129-160 */
    PPU_CORES1_IRQ = 51, /* Consolidated PPU Interrupt for
                            cores 33-64, 161-192 */
    PPU_CORES2_IRQ = 52, /* Consolidated PPU Interrupt for
                            cores 65-96, 193-224 */
    PPU_CORES3_IRQ = 53, /* Consolidated PPU Interrupt for
                            cores 97-128, 225-256 */
    ...
    PLL_CORES0_UNLOCK_IRQ = 57, /* Consolidated PLL unlock for PLLs
                                   1-32, 65-96, 129-160, 193-224 */
    PLL_CORES1_UNLOCK_IRQ = 58, /* Consolidated PLL lock for PLLs
                                   33-64, 97-128, 161-192, 225-256 */
    FAULT_CORES_IRQ = 59, /* Consolidated fault IRQ for
                             cores */
    RESERVED60_IRQ = 60, /* Reserved */
    RESERVED61_IRQ = 61, /* Reserved */
    RESERVED62_IRQ = 62, /* Reserved */
    RESERVED63_IRQ = 63, /* Reserved */
    ECC_CORES_ERROR_IRQ = 64, /* Consolidated ECC ERROR for
                                 cores */
    ...
    MHU_AP_NONSEC_IRQ = 82, /* MHU non-secure irq bewteen SCP and
                               AP */
    MHU_AP_SEC_IRQ = 83, /* MHU secure irq bewteen SCP and
                            AP */
    MHU_MCP_NONSEC_IRQ = 84, /* MHU non-secure irq between SCP and
                                MCP */
    MHU_MCP_SEC_IRQ = 85, /* MHU secure irq bewteen SCP and
                             MCP */
    RESERVED86_IRQ = 86, /* Reserved */
    RESERVED87_IRQ = 87, /* Reserved */
    RESERVED88_IRQ = 88, /* Reserved */
    RESERVED89_IRQ = 89, /* Reserved */
    TIMER_CLUSTERS_IRQ = 90, /* Consolidated clusters timer
                                interrupt */
    ...
    INT_PPU_IRQ = 96, /* PPU interrupt from Interconnect
                         PPU */
    ...
    INT_FAULTNS_IRQ = 100, /* Non-Sec fault interrupt from
                              Interconnect PPU */
    INT_PMU_DTC_GT_0_IRQ = 101, /* PMU count overflow irq
                                   if #DTC > 0 */
    INT_PMU_DTC_GT_1_IRQ = 102, /* PMU count overflow irq
                                   if #DTC > 1 */
    INT_PMU_DTC_GT_2_IRQ = 103, /* PMU count overflow irq
                                   if #DTC > 2 */
    INT_PMU_DTC_GT_3_IRQ = 104, /* PMU count overflow irq
                                   if #DTC > 3 */
    ...
    PPU_DPU_IRQ = 136, /* PPU DPU */
    PPU_GPU_IRQ = 137, /* PPU GPU */
    ...
    PLL_DPU_LOCK_IRQ = 144, /* DPU PLL Lock */
    PLL_DPU_UNLOCK_IRQ = 145, /* DPU PLL Unlock */
    PLL_GPU_LOCK_IRQ = 146, /* GPU PLL Lock */
    PLL_GPU_UNLOCK_IRQ = 147, /* GPU PLL Unlock */
    PLL_PXL_LOCK_IRQ = 148, /* PXL PLL Lock */
    PLL_PXL_UNLOCK_IRQ = 149, /* PXL PLL Unlock */
    ...
    CCIX_BUS_DEV_CHG_IRQ = 219, /* CCIX Bus Device Change
                                   interrupt */
    ...
    CCIX_PHY_INT_OUT_IRQ = 224, /* CCIX phy interrupt out
                                   interrupt */
    CCIX_AER_IRQ = 225, /* CCIX address enable interrupt */
    CCIX_LINK_DOWN_RESET_IRQ = 226, /* CCIX link down reset interrupt */
    CCIX_LOCAL_INT_REST_IRQ = 227, /* CCIX local error & status
                                      interrupt */
    CCIX_PERF_DATA_THRESHOLD_IRQ = 228, /* CCIX performance data threshold
                                           interrupt */
    CCIX_NEG_SPD_CHANGE_IRQ = 229, /* CCIX nogotiated speed change
                                      interrupt */
    CCIX_LINK_TRAIN_DONE_IRQ = 230, /* CCIX link training done
                                       interrupt */
    ...
    CCIX_FLR_RST_IRQ = 235, /* CCIX function level reset
                               interrupt */
    CCIX_PWR_STATE_CHANGE_IRQ = 236, /* CCIX power state change
                                        interrupt */
