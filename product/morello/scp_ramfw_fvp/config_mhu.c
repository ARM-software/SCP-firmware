...
static const struct fwk_element mhu_element_table[] = {
    [MORELLO_MHU_DEVICE_IDX_S_CLUS0] = { .name = "MHU_S_CLUSTER_0",
                                         .sub_element_count = 1,
                                         .data =
    ...
    [MORELLO_MHU_DEVICE_IDX_NS_CLUS0] = { .name = "MHU_NS_CLUSTER_0",
                                          .sub_element_count = 1,
                                          .data =
                                              &((struct mod_mhu_device_config){
    ...
    [MORELLO_MHU_DEVICE_IDX_NS_MCP] = { .name = "MHU_NS_MCP",
                                        .sub_element_count = 1,
                                        .data =
                                            &((struct mod_mhu_device_config){
                                                .irq = MHU_MCP_NONSEC_IRQ,
                                                .in = MHU_MCP_TO_SCP_NS,
                                                .out = MHU_SCP_TO_MCP_NS,
                                            }),
                                      },
