 ...
 */
/* 1333 MHz */
#define DDR_CLOCK_MHZ (4000.0 / 3)
/* (4400.0/3) for 1466MHz */

#define CPU_CLOCK_SUD 2100UL
#define CPU_CLOCK_UD  2200UL
#define CPU_CLOCK_NOM 2300UL
#define CPU_CLOCK_OD  2400UL
#define CPU_CLOCK_SOD 2500UL
...
#define PIK_CLK_RATE_CLUS0_CPU (2200 * FWK_MHZ)
#define PIK_CLK_RATE_CLUS1_CPU (2200 * FWK_MHZ)
 ...
 */
#define MORELLO_PLL_RATE_CPU_PLL0 (2200 * FWK_MHZ)
#define MORELLO_PLL_RATE_CPU_PLL1 (2200 * FWK_MHZ)
#define MORELLO_PLL_RATE_CLUSTER_PLL (1600 * FWK_MHZ)
#define MORELLO_PLL_RATE_INTERCONNECT_PLL (1600 * FWK_MHZ)
 ...
 * CSS clock rates.
 */
#define CSS_CLK_RATE_CPU_GRP0_SUPER_UNDERDRIVE (CPU_CLOCK_SUD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_UNDERDRIVE       (CPU_CLOCK_UD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_NOMINAL          (CPU_CLOCK_NOM * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_OVERDRIVE        (CPU_CLOCK_OD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_SUPER_OVERDRIVE  (CPU_CLOCK_SOD * FWK_MHZ)

#define CSS_CLK_RATE_CPU_GRP1_SUPER_UNDERDRIVE (CPU_CLOCK_SUD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_UNDERDRIVE       (CPU_CLOCK_UD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_NOMINAL          (CPU_CLOCK_NOM * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_OVERDRIVE        (CPU_CLOCK_OD * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_SUPER_OVERDRIVE  (CPU_CLOCK_SOD * FWK_MHZ)
