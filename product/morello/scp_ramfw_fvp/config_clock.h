 ...
 * CSS clock rates.
 */
#define CSS_CLK_RATE_CPU_GRP0_SUPER_UNDERDRIVE (2000 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_UNDERDRIVE (2100 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_NOMINAL (2200 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_OVERDRIVE (2300 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP0_SUPER_OVERDRIVE (2400 * FWK_MHZ)

#define CSS_CLK_RATE_CPU_GRP1_SUPER_UNDERDRIVE (2000 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_UNDERDRIVE (2100 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_NOMINAL (2200 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_OVERDRIVE (2300 * FWK_MHZ)
#define CSS_CLK_RATE_CPU_GRP1_SUPER_OVERDRIVE (2400 * FWK_MHZ)
