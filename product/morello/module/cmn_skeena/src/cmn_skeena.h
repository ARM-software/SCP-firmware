...
#define CMN_SKEENA_MAX_NUM_RNF 32
#define CMN_SKEENA_MAX_NUM_HNF 32
#define CMN_SKEENA_MAX_NUM_SCG 4
...
struct cmn_skeena_rnsam_reg {
    ...
    FWK_RW uint64_t NON_HASH_MEM_REGION0[5];
    FWK_RW uint64_t NON_HASH_TGT_NODEID0[3];
    FWK_RW uint64_t SYS_CACHE_GRP_REGION[2];
    FWK_RW uint64_t SYS_CACHE_GRP_HN_NODEID0[8];
    FWK_RW uint64_t SYS_CACHE_GRP_NOHASH_NODEID;
    FWK_RW uint64_t NON_HASH_MEM_REGION1[5];
    uint8_t RESERVED4[0xCE0 - 0xCC8];
    FWK_RW uint64_t NON_HASH_TGT_NODEID1[2];
    uint8_t RESERVED5[0xD00 - 0xCF0];
    FWK_RW uint64_t SYS_CACHE_GRP_HN_COUNT;
    FWK_RW uint64_t SYS_CACHE_GRP_SN_NODEID0[8];
    ...
    uint8_t RESERVED6[0xE00 - 0xD78];
    FWK_RW uint64_t CML_PORT_AGGR_MODE_CTRL;
    FWK_RW uint64_t CML_PORT_AGGR_GRP0_ADD_MASK;
    FWK_RW uint64_t CML_PORT_AGGR_GRP1_ADD_MASK;
    uint8_t RESERVED7[0xE30 - 0xE18];
    FWK_RW uint64_t CML_PORT_AGGR_MODE_CTRL1;
    uint8_t RESERVED8[0xE40 - 0xE38];
    FWK_RW uint64_t CML_PORT_AGGR_GRP0_AGGR;
    FWK_RW uint64_t CML_PORT_AGGR_GRP1_AGGR;
    uint8_t RESERVED9[0xF00 - 0xE50];
    FWK_RW uint64_t SYS_CACHE_GRP_SECONDARY[2];
    FWK_RW uint64_t SYS_CACHE_GRP_CAL_MODE;
    FWK_RW uint64_t RNSAM_HASH_ADDR_MASK;
    FWK_RW uint64_t RNSAM_REGION_CMP_ADDR_MASK;
    uint8_t RESERVED10[0xF58 - 0xF28];
    FWK_RW uint64_t SYS_CACHE_GRP_HN_NODEID1[8];
    uint8_t RESERVED11[0x1008 - 0xF98];
    FWK_RW uint64_t SYS_CACHE_GRP_SN_NODEID1[8];
};

/*
 * Debug and Trace registers
 */
struct cmn_skeena_dt_reg {
    FWK_R uint64_t NODE_INFO;
    uint8_t RESERVED0[0x80 - 0x8];
    FWK_R uint64_t CHILD_INFO;
...
struct cmn_skeena_rnd_reg {
    ...
    struct cmn_skeena_qos_reg S_QOS[3];
...
struct cmn_skeena_hnf_reg {
    ...
    FWK_RW uint64_t CFG_CTL;
    FWK_RW uint64_t AUX_CTL;
    FWK_RW uint64_t R2_AUX_CTL;
    uint8_t RESERVED4[0xA80 - 0xA18];
 ...
 */
struct cmn_skeena_mxp_reg {
    FWK_R uint64_t NODE_INFO;
    FWK_R uint64_t PORT_CONNECT_INFO[2];
    FWK_R uint64_t MESH_PORT_CONNECT_INFO_EAST;
    FWK_R uint64_t MESH_PORT_CONNECT_INFO_NORTH;
    ...
    struct cmn_skeena_qos_reg P_QOS[2];
...
#define CMN_SKEENA_NODE_INFO_TYPE UINT64_C(0x000000000000FFFF)
#define CMN_SKEENA_NODE_INFO_ID UINT64_C(0x00000000FFFF0000)
#define CMN_SKEENA_NODE_INFO_ID_POS 16
#define CMN_SKEENA_NODE_INFO_LOGICAL_ID UINT64_C(0x0000FFFF00000000)
#define CMN_SKEENA_NODE_INFO_LOGICAL_ID_POS 32

#define CMN_SKEENA_CHILD_INFO_COUNT UINT64_C(0x000000000000FFFF)

#define CMN_SKEENA_CHILD_POINTER UINT64_C(0x00000000FFFFFFFF)
#define CMN_SKEENA_CHILD_POINTER_OFFSET UINT64_C(0x000000000FFFFFFF)
#define CMN_SKEENA_CHILD_POINTER_EXT UINT64_C(0x0000000080000000)

/* External child node */
#define CMN_SKEENA_CHILD_POINTER_EXT_REGISTER_OFFSET \
    UINT64_C(0x0000000000003FFF)
#define CMN_SKEENA_CHILD_POINTER_EXT_NODE_POINTER UINT64_C(0x000000000FFFC000)
#define CMN_SKEENA_CHILD_POINTER_EXT_NODE_POINTER_POS 14

/* Used by NON_HASH_MEM_REGIONx and SYS_CACHE_GRP_REGIONx group registers */
#define CMN_SKEENA_RNSAM_REGION_ENTRY_VALID_POS 0
#define CMN_SKEENA_RNSAM_REGION_ENTRY_EN_POS \
    1 /* Not available for all regions */
#define CMN_SKEENA_RNSAM_REGION_ENTRY_TYPE_POS 2
#define CMN_SKEENA_RNSAM_REGION_ENTRY_SIZE_POS 4
#define CMN_SKEENA_RNSAM_REGION_ENTRY_BASE_POS 9
#define CMN_SKEENA_RNSAM_REGION_ENTRY_BITS_WIDTH 32
#define CMN_SKEENA_RNSAM_REGION_ENTRY_VALID UINT64_C(0x0000000000000001)
#define CMN_SKEENA_RNSAM_REGION_ENTRY_MASK UINT64_C(0xFFFFFFFF)
#define CMN_SKEENA_RNSAM_REGION_ENTRIES_PER_GROUP 2
#define CMN_SKEENA_RNSAM_MAX_HASH_MEM_REGION_ENTRIES 4
#define CMN_SKEENA_RNSAM_MAX_NON_HASH_MEM_REGION_ENTRIES 20
#define CMN_SKEENA_RNSAM_SCG_HNF_CAL_MODE_EN UINT64_C(0x01)
#define CMN_SKEENA_RNSAM_SCG_HNF_CAL_MODE_SHIFT 16

#define CMN_SKEENA_RNSAM_STATUS_UNSTALL UINT64_C(0x0000000000000002)

#define CMN_SKEENA_HNF_SAM_MEMREGION_SIZE_POS 12
#define CMN_SKEENA_HNF_SAM_MEMREGION_BASE_POS 26
#define CMN_SKEENA_HNF_SAM_MEMREGION_VALID UINT64_C(0x8000000000000000)

#define CMN_SKEENA_HNF_CACHE_GROUP_ENTRIES_MAX 32
#define CMN_SKEENA_HNF_CACHE_GROUP_ENTRIES_PER_GROUP 4
#define CMN_SKEENA_HNF_CACHE_GROUP_ENTRY_BITS_WIDTH 12

#define CMN_SKEENA_HNI_SAM_REGION_CFG_SER_DEVNE_WR UINT64_C(0x1000000000000000)

#define CMN_SKEENA_RND_CFG_CTL_PCIE_MSTR_PRESENT UINT64_C(0x0000000000000020)

#define CMN_SKEENA_RNSAM_NON_HASH_TGT_NODEID_ENTRY_BITS_WIDTH 12
#define CMN_SKEENA_RNSAM_NON_HASH_TGT_NODEID_ENTRY_MASK UINT64_C(0xFFF)
#define CMN_SKEENA_RNSAM_NON_HASH_TGT_NODEID_ENTRIES_PER_GROUP 4

#define CMN_SKEENA_PPU_PWPR_POLICY_OFF UINT64_C(0x0000000000000000)
#define CMN_SKEENA_PPU_PWPR_POLICY_MEM_RET UINT64_C(0x0000000000000002)
#define CMN_SKEENA_PPU_PWPR_POLICY_FUNC_RET UINT64_C(0x000000000000007)
#define CMN_SKEENA_PPU_PWPR_POLICY_ON UINT64_C(0x0000000000000008)
#define CMN_SKEENA_PPU_PWPR_OPMODE_NOSFSLC UINT64_C(0x0000000000000000)
#define CMN_SKEENA_PPU_PWPR_OPMODE_SFONLY UINT64_C(0x0000000000000010)
#define CMN_SKEENA_PPU_PWPR_OPMODE_HAM UINT64_C(0x0000000000000020)
#define CMN_SKEENA_PPU_PWPR_OPMODE_FAM UINT64_C(0x0000000000000030)
#define CMN_SKEENA_PPU_PWPR_DYN_EN UINT64_C(0x0000000000000100)

/* Mesh and Node ID mapping */
#define CMN_SKEENA_MESH_X_MAX 8
#define CMN_SKEENA_MESH_Y_MAX 8

#define CMN_SKEENA_NODE_ID_PORT_POS 2
#define CMN_SKEENA_NODE_ID_PORT_MASK 0x1
#define CMN_SKEENA_NODE_ID_Y_POS 3

#define CMN_SKEENA_MXP_PORT_CONNECT_INFO_DEVICE_TYPE_MASK UINT64_C(0x1F)

#define CMN_SKEENA_ROOT_NODE_OFFSET_PORT_POS 14
#define CMN_SKEENA_ROOT_NODE_OFFSET_Y_POS 20

/* Peripheral ID Revision Numbers */
#define CMN_SKEENA_PERIPH_ID_2_REV_R1_P0 ((0x00 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R1_P1 ((0x01 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R1_P2 ((0x02 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R1_P3 ((0x03 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R2_P0 ((0x04 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R3_P0 ((0x05 << 4) + (0x0B))
#define CMN_SKEENA_PERIPH_ID_2_REV_R3_P1 ((0x06 << 4) + (0x0B))

/* Peripheral ID Revision Numbers */
#define CMN_SKEENA_PERIPH_ID_2_MASK UINT64_C(0xFF)
 ...
 * external node from the CMN_SKEENA instance point of view.
 *
 * \param node_base Pointer to the parent node descriptor
 *      \pre The node pointer must be valid
 * \param child_index Child index
...
/*
 * Convert a memory region size into a size format used by the CMN_SKEENA
 * registers The format is the binary logarithm of the memory region size
 * represented as blocks multiple of the CMN_SKEENA's granularity: n = log2(size
 * / SAM_GRANULARITY)
 *
 ...
 *
 * \param base CMN_SKEENA peripheral base address
...
/*
 * Check if CMN_SKEENA supports CAL mode. CAL mode is supported from CMN_SKEENA
 * r2p0.
 *
 * \param root Pointer to the root node descriptor
 *
 * \retval true if the CMN_SKEENA revision is found to be r2p0 or above
 * \retval false if the CMN_SKEENA revision is found to be r1p3 or below
 */
