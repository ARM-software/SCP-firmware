...
#ifndef MORELLO_PCIE_H
#define MORELLO_PCIE_H
...
#define NIC400_SOC_GPV_BASE UINT32_C(0xC2000000)

/* PCIe Vendor ID and Device ID definition */
#define MORELLO_PCIE_VENDOR_ID_ARM      0x13B5U
#define MORELLO_PCIE_VENDOR_ID_ARM_MASK 0xFFFFU

#define MORELLO_PCIE_DEVICE_ID_ARM      0x100U
#define MORELLO_PCIE_DEVICE_ID_ARM_MASK 0xFFFF0000U
 ...
 */
#define PCIE_PHY_PLL_LOCK_TIMEOUT     UINT32_C(1000)
#define PCIE_CTRL_RC_RESET_TIMEOUT    UINT32_C(500)
#define PCIE_LINK_TRAINING_TIMEOUT    UINT32_C(200000)
#define PCIE_LINK_RE_TRAINING_TIMEOUT UINT32_C(2000000)
...
#define PCIE_LM_AXI_FEATURE_CONFIG UINT32_C(0xE5C)
...
#define MAX_BUS_LEVELS 128

/* Maximum AXI space for type 0 and type 1 transactions */
#define AXI_ECAM_SIZE (MAX_BUS_LEVELS * MAX_ECAM_SPACE_PER_BUS)

/* Maximum AXI space for MMIO64, MMIO32 & IO transactions */
#define AXI_MMIO64_SIZE (63 * FWK_GIB)
#define AXI_MMIO32_SIZE (240 * FWK_MIB)
#define AXI_IO_SIZE     (16 * FWK_MIB)

/*
 * PCIe AXI subordinate ECAM memory mapping
 */
#define PCIE_AXI_ECAM_OFFSET UINT64_C(0)

/*
 * CCIX AXI subordinate ECAM memory mapping
 */
#define CCIX_AXI_ECAM_OFFSET UINT64_C(0)

/*
 * PCIe AXI subordinate MMIO64 memory mapping
 */
#define PCIE_AXI_MMIO64_OFFSET UINT64_C(0x40000000)

/*
 * CCIX AXI subordinate MMIO64 memory mapping
 */
#define CCIX_AXI_MMIO64_OFFSET UINT64_C(0x40000000)

/* PCIe AXI subordinate IO offset addresses */
#define PCIE_AXI_IO_OFFSET (0x0F000000)

/* CCIX AXI subordinate IO offset addresses */
#define CCIX_AXI_IO_OFFSET (0x0F000000)
...
#define CCIX_RC_TX_PRESET_VALUE 0x6
 ...
 * param - region_idx - Region identifier of the outbound region
 ...
 */
int pcie_rp_ep_config_write_word(
    uint32_t base,
    uint32_t offset,
    uint32_t value);
 ...
 */
int pcie_rp_ep_config_read_word(
    uint32_t base,
    uint32_t offset,
    uint32_t *value);
