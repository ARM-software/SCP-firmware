...
/*
 * DMC-Bing ADDRESS_CONTROL register bit field values
 */
...
/*
 * DMC Bing FORMAT_CONTROL register bit field values
 */
...
/*
 * DMC-Bing MEMORY_TYPE register bit field values
 */
 ...
 *          FWK_E_DATA - if the value cannot be calculated
 */
void dimm_spd_t_refi(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_rfc(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_rcd(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_ras(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_rp(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_rrd(uint32_t *value);
 ...
 * retval - NONE
 */
void dimm_spd_t_wtr(uint32_t *value, struct dimm_info *info);
