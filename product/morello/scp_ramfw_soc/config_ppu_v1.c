...
static const unsigned int cluster_idx_to_node_id[2] = { 192, 140 };
...
static struct fwk_element
                ppu_v1_static_element_table[PPU_V1_ELEMENT_IDX_COUNT] = {
    [PPU_V1_ELEMENT_IDX_SYS0] = {
        .name = "SYS0",
...
static const struct fwk_element *ppu_v1_get_element_table(fwk_id_t module_id)
{
    ...
    element_table = fwk_mm_calloc(
        core_count + cluster_count +
            FWK_ARRAY_SIZE(ppu_v1_static_element_table) + 1,
    ...
    for (cluster_idx = 0; cluster_idx < cluster_count; cluster_idx++) {
        ...
        pd_config->opmode = (SCC->BOOT_GPR1 & SCC_BOOTGPR1_L3_CACHE_EN_MASK) ?
            PPU_V1_OPMODE_04 :
            PPU_V1_OPMODE_00;
    }
    ...
    (void)memcpy(
        ...
        ppu_v1_static_element_table,
        sizeof(ppu_v1_static_element_table));
