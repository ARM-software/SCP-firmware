...
static const uint32_t cluster_pd_allowed_state_mask_table[2] = {
    ...
    [MOD_PD_STATE_ON] = TC1_CLUSTER_VALID_STATE_MASK,
};
...
static const uint32_t core_pd_allowed_state_mask_table[2] = {
    ...
    [MOD_PD_STATE_ON] = TC1_CORE_VALID_STATE_MASK,
};

/* Power module specific configuration data (none) */
static const struct mod_power_domain_config tc1_power_domain_config = { 0 };

static struct fwk_element tc1_power_domain_static_element_table[1] = {
 ...
 */
static const struct fwk_element *tc1_power_domain_get_element_table(
    fwk_id_t module_id)
{
    return create_power_domain_element_table(
        tc1_core_get_core_count(),
        ...
        tc1_power_domain_static_element_table,
        FWK_ARRAY_SIZE(tc1_power_domain_static_element_table));
}
...
const struct fwk_module_config config_power_domain = {
    .elements = FWK_MODULE_DYNAMIC_ELEMENTS(tc1_power_domain_get_element_table),
    .data = &tc1_power_domain_config,
};
