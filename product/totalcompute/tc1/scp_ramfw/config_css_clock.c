...
static const struct mod_css_clock_rate rate_table_cpu_group_cortex_a510[5] = {
    {
        ...
        .clock_source = MOD_PIK_CLOCK_CLUSCLK_SOURCE_TC1_PLL0,
...
static const struct mod_css_clock_rate rate_table_cpu_group_cortex_a715[5] = {
    {
        ...
        .clock_source = MOD_PIK_CLOCK_CLUSCLK_SOURCE_TC1_PLL1,
        .clock_div_type = MOD_PIK_CLOCK_MSCLOCK_DIVIDER_DIV_EXT,
        .clock_div = 1,
        .clock_mod_numerator = 1,
        .clock_mod_denominator = 1,
...
static const struct mod_css_clock_rate rate_table_cpu_group_cortex_x3[5] = {
    {
        ...
        .clock_source = MOD_PIK_CLOCK_CLUSCLK_SOURCE_TC1_PLL2,
        .clock_div_type = MOD_PIK_CLOCK_MSCLOCK_DIVIDER_DIV_EXT,
        .clock_div = 1,
        .clock_mod_numerator = 1,
        .clock_mod_denominator = 1,
