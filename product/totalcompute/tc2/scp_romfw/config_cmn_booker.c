 ...
 * CMN_BOOKER nodes
 */
#define MEM_CNTRL0_ID     8
#define MEM_CNTRL1_ID     40
#define MEM_CNTRL2_ID     0
#define MEM_CNTRL3_ID     38
#define NODE_ID_HND       44
#define NODE_ID_MTSX_BOOT 36
...
static const struct mod_cmn_booker_mem_region_map mmap[7] = {
    {
        /*
    ...
    },
    {
        ...
        .type = MOD_CMN_BOOKER_REGION_TYPE_SYSCACHE_SUB,
        .node_id = NODE_ID_MTSX_BOOT,
    },
    {
        /*
         * Peripherals
