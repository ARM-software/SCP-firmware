...
uint32_t hunter_layout[] = {
    [HUNTER_AMEVCNTR0_CORE] = 0,
    [HUNTER_AMEVCNTR0_CONST] = sizeof(uint64_t) * 1,
    [HUNTER_AMEVCNTR0_INST_RET] = sizeof(uint64_t) * 2,
    [HUNTER_AMEVCNTR0_MEM_STALL] = sizeof(uint64_t) * 3,
    [HUNTER_AMEVCNTR1_AUX0] = SCP_AMU_AMEVCNTR1_OFFSET,
    [HUNTER_AMEVCNTR1_AUX1] = SCP_AMU_AMEVCNTR1_OFFSET + sizeof(uint64_t) * 1,
    [HUNTER_AMEVCNTR1_AUX2] = SCP_AMU_AMEVCNTR1_OFFSET + sizeof(uint64_t) * 2,
};

static struct mod_core_element_config core_config [CORE_COUNT_IDX] = {
    [CORE0_IDX] = {
        .counters_base_addr = (uint64_t *)SCP_AMU_CORE_BASE(CORE0_IDX),
        .counters_offsets = hunter_layout,
    },
    [CORE1_IDX] = {
...
static const struct fwk_element element_table[] = {
    [CORE0_IDX] = {
        ...
        .sub_element_count = HUNTER_AMEVCNTR_COUNT,
    },
    [CORE1_IDX] = {
        .name = "Core1 AMU base",
