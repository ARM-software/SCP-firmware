...
typedef enum IRQn {
    ...
    FAULT_CORES0_IRQ = 59, /* Consolidated fault IRQ for cores 1-32, 129-160 */
    FAULT_CORES1_IRQ = 60, /* Consolidated fault IRQ for cores 33-64, 161-192 */
    FAULT_CORES2_IRQ = 61, /* Consolidated fault IRQ for cores 65-96, 193-224 */
    FAULT_CORES3_IRQ =
        62, /* Consolidated fault IRQ for cores 97-128, 225-256 */
    FAULT_CLUSTERS_IRQ = 63, /* Consolidated clusters fault */
    ECC_CORES0_ERROR_IRQ =
        64, /* Consolidated ECC ERROR for cores 1-32, 129-160 */
    ECC_CORES1_ERROR_IRQ =
        65, /* Consolidated ECC ERROR for cores 33-64, 161-192 */
    ECC_CORES2_ERROR_IRQ =
        66, /* Consolidated ECC ERROR for cores 65-96, 193-224 */
    ECC_CORES3_ERROR_IRQ =
        67, /* Consolidated ECC ERROR for cores 96-128, 225-256 */
