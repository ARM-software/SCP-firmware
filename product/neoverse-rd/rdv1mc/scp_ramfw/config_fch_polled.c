...
static const struct fwk_element fch_polled_element_table[] = {
    [RDV1MC_PLAT_FCH_CPU0_LEVEL_SET] = { .name = "FCH_RDV1MC_CPU0_LEVEL_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_SET_ADDR(
    ...
    [RDV1MC_PLAT_FCH_CPU0_LIMIT_SET] = { .name = "FCH_RDV1MC_CPU0_LIMIT_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_SET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU0),
                                             FC_LIMIT_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU0),
                                             FCH_POLLED_LIMIT_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU0_LEVEL_GET] = { .name = "FCH_RDV1MC_CPU0_LEVEL_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU0),
    ...
    [RDV1MC_PLAT_FCH_CPU0_LIMIT_GET] = { .name = "FCH_RDV1MC_CPU0_LIMIT_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU0),
                                             FC_LIMIT_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU0),
                                             FCH_POLLED_LIMIT_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU1_LEVEL_SET] = { .name = "FCH_RDV1MC_CPU1_LEVEL_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_SET_ADDR(
                                             ...
                                             FC_LEVEL_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FCH_POLLED_LEVEL_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU1_LIMIT_SET] = { .name = "FCH_RDV1MC_CPU1_LIMIT_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_SET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FC_LIMIT_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FCH_POLLED_LIMIT_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU1_LEVEL_GET] = { .name = "FCH_RDV1MC_CPU1_LEVEL_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FC_LEVEL_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FCH_POLLED_LEVEL_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU1_LIMIT_GET] = { .name = "FCH_RDV1MC_CPU1_LIMIT_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FC_LIMIT_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU1),
                                             FCH_POLLED_LIMIT_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU2_LEVEL_SET] = { .name = "FCH_RDV1MC_CPU2_LEVEL_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_SET_ADDR(
                                             ...
                                             FC_LEVEL_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FCH_POLLED_LEVEL_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU2_LIMIT_SET] = { .name = "FCH_RDV1MC_CPU2_LIMIT_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_SET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FC_LIMIT_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FCH_POLLED_LIMIT_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU2_LEVEL_GET] = { .name = "FCH_RDV1MC_CPU2_LEVEL_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FC_LEVEL_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FCH_POLLED_LEVEL_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU2_LIMIT_GET] = { .name = "FCH_RDV1MC_CPU2_LIMIT_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FC_LIMIT_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU2),
                                             FCH_POLLED_LIMIT_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU3_LEVEL_SET] = { .name = "FCH_RDV1MC_CPU3_LEVEL_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_SET_ADDR(
                                             ...
                                             FC_LEVEL_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FCH_POLLED_LEVEL_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU3_LIMIT_SET] = { .name = "FCH_RDV1MC_CPU3_LIMIT_SET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_SET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FC_LIMIT_SET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FCH_POLLED_LIMIT_SET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU3_LEVEL_GET] = { .name = "FCH_RDV1MC_CPU3_LEVEL_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LEVEL_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FC_LEVEL_GET_AP_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FCH_POLLED_LEVEL_GET_LENGTH) },
    [RDV1MC_PLAT_FCH_CPU3_LIMIT_GET] = { .name = "FCH_RDV1MC_CPU3_LIMIT_GET",
                                         .data = FCH_ADDR_INIT(
                                             FC_LIMIT_GET_ADDR(
                                                 DVFS_ELEMENT_IDX_CPU3),
                                             FC_LIMIT_GET_AP_ADDR(
