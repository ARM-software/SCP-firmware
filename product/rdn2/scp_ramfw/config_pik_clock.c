...
static const struct fwk_element pik_clock_element_table[] = {
    [CLOCK_PIK_IDX_CLUS0_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            ...
            .control_reg = &CLUSTER_PIK_PTR(0)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(0)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(0)->CORECLK_MOD1,
    ...
    [CLOCK_PIK_IDX_CLUS1_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(1)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(1)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(1)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS2_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(2)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(2)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(2)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS3_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(3)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(3)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(3)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS4_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(4)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(4)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(4)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS5_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(5)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(5)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(5)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS6_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(6)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(6)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(6)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS7_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(7)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(7)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(7)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS8_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(8)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(8)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(8)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS9_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(9)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(9)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(9)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS10_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(10)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(10)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(10)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS11_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(11)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(11)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(11)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS12_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(12)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(12)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(12)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS13_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(13)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(13)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(13)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS14_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(14)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(14)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(14)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
    [CLOCK_PIK_IDX_CLUS15_CPU0] = {
        ...
        .data = &((struct mod_pik_clock_dev_config) {
            .type = MOD_PIK_CLOCK_TYPE_CLUSTER,
            .is_group_member = true,
            .control_reg = &CLUSTER_PIK_PTR(15)->CORECLK_CTRL,
            .divext_reg = &CLUSTER_PIK_PTR(15)->CORECLK_DIV1,
            .modulator_reg = &CLUSTER_PIK_PTR(15)->CORECLK_MOD1,
            .rate_table = rate_table_cpu_group,
            .rate_count = FWK_ARRAY_SIZE(rate_table_cpu_group),
        }),
    },
