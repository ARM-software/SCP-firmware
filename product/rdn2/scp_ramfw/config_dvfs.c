...
static struct mod_dvfs_opp opps[] = {
    { .level = 2300 * 1000000UL, .frequency = 2300 * FWK_KHZ, .voltage = 900 },
    { .level = 2600 * 1000000UL, .frequency = 2600 * FWK_KHZ, .voltage = 950 },
    { .level = 3200 * 1000000UL, .frequency = 3200 * FWK_KHZ, .voltage = 1000 },
    { 0 }
};
