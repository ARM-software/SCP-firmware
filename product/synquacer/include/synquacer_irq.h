...
#ifndef SYNQUACER_IRQ_H
#define SYNQUACER_IRQ_H

enum scp_interrupt {
    WDOG_IRQn = -14, /*!< SCP Watchdog (SP805) - NMI */
    ...
    MHU_NON_SEC_SCP_AP_IRQn = 82, /*!< MHU non-secure irq bewteen SCP and AP */
    MHU_SEC_SCP_AP_IRQn = 83, /*!< MHU secure irq bewteen SCP and AP */
    MHU_NON_SEC_SCP_MCP_IRQn =
        84, /*!< MHU non-secure irq between SCP and MCP */
    MHU_SEC_SCP_MCP_IRQn = 85, /*!< MHU secure irq bewteen SCP and MCP */
