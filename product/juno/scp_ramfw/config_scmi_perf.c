...
static const struct mod_scmi_perf_domain_config domains[] = {
    [DVFS_ELEMENT_IDX_LITTLE] = {
        ...
        .fast_channels_addr_scp = (uint64_t[]) {
            [MOD_SCMI_PERF_FAST_CHANNEL_LEVEL_SET] = SCMI_FAST_CHANNEL_BASE
                + MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_LEVEL_SET
                + (MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_TOTAL
                * DVFS_ELEMENT_IDX_LITTLE),
            [MOD_SCMI_PERF_FAST_CHANNEL_LIMIT_SET] = SCMI_FAST_CHANNEL_BASE
                + MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_LIMIT_SET
                + (MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_TOTAL
                * DVFS_ELEMENT_IDX_LITTLE),
            [MOD_SCMI_PERF_FAST_CHANNEL_LEVEL_GET] = SCMI_FAST_CHANNEL_BASE
                + MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_LEVEL_GET
                + (MOD_SCMI_PERF_FAST_CHANNEL_OFFSET_TOTAL
                * DVFS_ELEMENT_IDX_LITTLE),
            [MOD_SCMI_PERF_FAST_CHANNEL_LIMIT_GET] = SCMI_FAST_CHANNEL_BASE
