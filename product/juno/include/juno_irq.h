 ...
 *
 * Description:
 *     SoC-level interrupt definitions for the SCP
*/
...
enum juno_irq {
    ...
    LITTLE_SAC_WAKEUP_REQ_IRQ = 20,  /* LITTLE CPU Snoop Access Wakeup
                                        Request */
    EXT_IF_WAKEUP_IRQ         = 21,  /* Extension Interface Access Wake-Up
                                        Request */
    EXT_IF_SERVICE_IRQ        = 22,  /* Extension Interface Access Service
                                        Request */
