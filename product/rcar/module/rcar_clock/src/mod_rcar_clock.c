...
static const
    struct op_points rcar_h3_a57_op_points[EFUSE_AVS_NUM][NR_H3_A57_OPP] = {
    {
        { 500000000,  830000, },
        { 1000000000, 830000, },
        { 1500000000, 830000, },
...
static const
    struct op_points rcar_h3_a53_op_points[NR_H3_A53_OPP] = {
    { 800000000,  820000, },
    { 1000000000, 820000, },
    { 1200000000, 820000, },
};
...
static const
    struct op_points rcar_m3_a57_op_points[EFUSE_AVS_NUM][NR_M3_A57_OPP] = {
    {
        { 500000000,  830000, },
        { 1000000000, 830000, },
        { 1500000000, 830000, },
...
static const
    struct op_points rcar_m3_a53_op_points[NR_M3_A53_OPP] = {
    { 800000000,  820000, },
    { 1000000000, 820000, },
    { 1200000000, 820000, },
    { 1300000000, 820000, },
...
static unsigned long pll0_clk_recalc_rate(void)
{
    ...
    val = (mmio_read_32(CPG_PLL0CR) & CPG_PLLCR_STC_MASK)
            >> CPG_PLLCR_STC_SHIFT;
...
static unsigned long pll2_clk_recalc_rate(void)
{
    ...
    val = (mmio_read_32(CPG_PLL2CR) & CPG_PLLCR_STC_MASK)
            >> CPG_PLLCR_STC_SHIFT;
...
static int do_rcar_clock_set_rate(fwk_id_t dev_id, uint64_t rate,
...
static int rcar_clock_set_rate(fwk_id_t dev_id, uint64_t rate,
                              enum mod_clock_round_mode round_mode)
{
    struct rcar_clock_dev_ctx *ctx;
...
static int rcar_clock_init(fwk_id_t module_id, unsigned int element_count,
                          const void *data)
{
    ...
    module_ctx.dev_ctx_table = fwk_mm_calloc(element_count,
                                             sizeof(struct rcar_clock_dev_ctx));
...
static int rcar_clock_element_init(fwk_id_t element_id,
...
static int rcar_clock_process_bind_request(fwk_id_t source_id,
