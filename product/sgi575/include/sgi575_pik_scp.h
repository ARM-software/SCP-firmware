...
struct pik_scp_reg {
    ...
    FWK_W   uint32_t  CONS_MMUTBU_INT_CLR1;
            uint8_t   RESERVED9[0xB00 - 0xA78];
    FWK_R   uint32_t  MHU_NS_INT_STATUS;
    FWK_R   uint32_t  MHU_S_INT_STATUS;
            uint8_t   RESERVED10[0xB20 - 0xB08];
    FWK_R   uint32_t  CPU_PPU_INT_STATUS[8];
    FWK_R   uint32_t  CLUS_PPU_INT_STATUS;
            uint8_t   RESERVED11[0xB60 - 0xB44];
    FWK_R   uint32_t  TIMER_INT_STATUS[8];
    FWK_RW  uint32_t  CPU_PLL_LOCK_STATUS[8];
            uint8_t   RESERVED12[0xBC0 - 0xBA0];
    FWK_RW  uint32_t  CPU_PLL_UNLOCK_STATUS[8];
            uint8_t   RESERVED13[0xBF0 - 0xBE0];
    FWK_RW  uint32_t  CLUSTER_PLL_LOCK_STATUS;
    FWK_RW  uint32_t  CLUSTER_PLL_UNLOCK_STATUS;
            uint8_t   RESERVED14[0xC00 - 0xBF8];
    FWK_R   uint32_t  CLUS_FAULT_INT_STATUS;
            uint8_t   RESERVED15[0xC30 - 0xC04];
    FWK_R   uint32_t  CLUSTER_ECCERR_INT_STATUS;
            uint8_t   RESERVED16[0xD00 - 0xC34];
    ...
    FWK_R   uint32_t  DMC3_7_INT_STATUS;
            uint8_t   RESERVED17[0xFC0 - 0xD10];
