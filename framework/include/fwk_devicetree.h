 ...
 *
 * Copy of the devicetree.h file from Zephyr - with zephyr specific elements removed.
 */
#ifndef FWK_DEVICETREE_H
#define FWK_DEVICETREE_H

#include <dt_sys/util.h>

/**
 * @brief fwk_devicetree.h API
